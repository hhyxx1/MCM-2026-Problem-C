...
\mcmsetup{tstyle = \color{red}\bfseries,  % 修改题号，队号的颜色和加粗显示，黑色可以修改为 black
          tcn = 2627699, problem = C,     % 修改队号，参赛题号
...
\title{The Fairness-Engagement Equilibrium Model for DWTS Voting Reform}
...
\begin{keywords}
Reality Competition Voting; Bayesian Inverse Inference; Pareto Optimization; Dynamic Weighting; Rank-based Scoring; Mixed-Effects Model
\end{keywords}
...
\subsection{Identified Data Anomalies}
...
\subsection{Judge Score Standardization ($J\%$)}
...
\subsection{Panel Data Conversion}
...
\subsection{Covariate Standardization}

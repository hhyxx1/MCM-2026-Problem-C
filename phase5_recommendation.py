...
ax1_ind.fill_between(weeks, 0, alphas, alpha=0.3, color='steelblue', label=r'Judge Weight $\alpha$(t)')
ax1_ind.fill_between(weeks, alphas, 1, alpha=0.3, color='coral', label=r'Fan Weight $\beta$(t)')
ax1_ind.plot(weeks, alphas, 'b-o', markersize=6)
ax1_ind.axhline(y=0.5, color='gray', linestyle='--', alpha=0.5)
ax1_ind.set_xlabel('Week (t)')
ax1_ind.set_ylabel('Weight')
ax1_ind.set_title(r'Dynamic Weighting: $\alpha$(t) vs $\beta$(t) by Week')
...
ax2_ind.axvline(x=5, color='red', linestyle='--', linewidth=2, label=r'Fan Extreme ($\Delta$=+5)')
ax2_ind.axvline(x=-5, color='blue', linestyle='--', linewidth=2, label=r'Judge Extreme ($\Delta$=-5)')
ax2_ind.axvline(x=0, color='black', linestyle='-', linewidth=1)
ax2_ind.set_xlabel(r'$\Delta$ (Popularity Bias Index = R$^{\mathcal{J}}$ - R*)')
ax2_ind.set_ylabel('Frequency')
ax2_ind.set_title(r'Distribution of $\Delta$ Across All Contestants')
ax2_ind.legend()
plt.tight_layout()
...
width = 0.35
bars1 = ax3_ind.bar(x_m - width/2, jfi_values, width, label=r'$\mathcal{M}$ (Meritocracy)', color='steelblue')
bars2 = ax3_ind.bar(x_m + width/2, ffi_values, width, label=r'$\mathcal{F}$ (Engagement)', color='coral')
ax3_ind.set_ylabel('Index Value')
ax3_ind.set_title(r'Method Comparison: $\mathcal{M}$ vs $\mathcal{F}$')
...
ax1.fill_between(weeks, 0, alphas, alpha=0.3, color='steelblue', label=r'Judge Weight $\alpha$(t)')
ax1.fill_between(weeks, alphas, 1, alpha=0.3, color='coral', label=r'Fan Weight $\beta$(t)')
ax1.plot(weeks, alphas, 'b-o', markersize=6)
ax1.axhline(y=0.5, color='gray', linestyle='--', alpha=0.5)
ax1.set_xlabel('Week (t)')
ax1.set_ylabel('Weight')
ax1.set_title(r'Dynamic Weighting: $\alpha$(t) vs $\beta$(t) by Week')
ax1.set_ylim(0, 1)
...
ax2.axvline(x=5, color='red', linestyle='--', linewidth=2, label=r'Fan Extreme ($\Delta$=+5)')
ax2.axvline(x=-5, color='blue', linestyle='--', linewidth=2, label=r'Judge Extreme ($\Delta$=-5)')
ax2.axvline(x=0, color='black', linestyle='-', linewidth=1)
ax2.set_xlabel(r'$\Delta$ (Popularity Bias Index = R$^{\mathcal{J}}$ - R*)')
ax2.set_ylabel('Frequency')
ax2.set_title(r'Distribution of $\Delta$ Across All Contestants')
ax2.legend()
...
bars1 = ax3.bar(x - width/2, jfi_values, width, label=r'$\mathcal{M}$ (Meritocracy)', color='steelblue')
bars2 = ax3.bar(x + width/2, ffi_values, width, label=r'$\mathcal{F}$ (Engagement)', color='coral')

ax3.set_ylabel('Index Value')
ax3.set_title(r'Method Comparison: $\mathcal{M}$ vs $\mathcal{F}$')
ax3.set_xticks(x)

...
\subsection{Global Scan: The Social Media Effect}
We performed a chronological scan of Judge-Audience divergence across 34 seasons (Figure \ref{fig:divergence}). A clear upward trend suggests that the gap between expert judgment and popular voting has widened, notably correlating with the rise of social media eras:
\begin{itemize}[nosep]
    \item \textbf{Early Era (S1--15):} Low divergence, viewers voted largely on performance.
    \item \textbf{Social Media Era (S16--27):} Divergence spikes, coinciding with the rise of Instagram/Twitter campaigns.
    \item \textbf{Streaming Era (S28+):} Divergence stabilizes but remains high.
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{global_scan_heatmap.png}
    \caption{Chronological Heatmap of Judge-Audience Divergence}
...
\subsection{Variance Decomposition \& Star Makers}
\begin{table}[H]
\centering
...
\begin{itemize}[nosep]
    \item \textbf{Derek Hough:} +8.1 points (Judge Score Lift), +4.2\% (Fan Vote Lift)
    \item \textbf{Mark Ballas:} +6.5 points (Judge), +3.8\% (Fan)
\end{itemize}
